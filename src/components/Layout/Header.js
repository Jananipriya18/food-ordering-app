...
import Logo from "../../images/epicurean.png";
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      ...
      <ul className="mobile-navigation">
        ...
        <li>
          <NavLink to={"/restaurantList"}>Restaurant List</NavLink> {/* Add this link */}
        </li>
      </ul>
    ...
    {[false].map((expand) => (
        <Navbar key={expand} expand={expand} className="bg-dark navbar-dark mb-3">
          <Container fluid>
            ...
            {/* <Navbar.Brand href="/restaurant">Restaurant</Navbar.Brand> */}
            <Navbar.Brand href="/resListPage">Restaurant</Navbar.Brand>
            <Navbar.Brand href="/about">About</Navbar.Brand>
            <Navbar.Brand href="/contact">Contacts</Navbar.Brand>
          ...
          <Toolbar>
            ...
            <Box sx={{ display: { xs: "none", sm: "block" } }}>
              <ul className="navigation-menu">
                ...
                <li>
                  <NavLink to={"/resListPage"}>Restaurant List</NavLink> {/* Add this link 
                </li>
              </ul>
            </Box>
          </Toolbar>
